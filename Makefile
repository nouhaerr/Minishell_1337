...
#    Updated: 2023/05/24 11:48:34 by nerrakeb         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS =	main.c ft_lst_lex.c utils.c parse.c ft_lst_parse.c env.c tokens.c \
		free_mylist.c execution/builtins/echo.c execution/builtins/pwd.c \
