...
#    Updated: 2023/06/17 15:29:59 by nerrakeb         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS =	main.c parsing/my_free.c parsing/ft_lst_one.c \
		...
		#execution/redirections/files.c execution/begin_exec.c #signal.c
		
OBJS = $(SRCS:.c=.o)
LIBFT= libft.a
LIBFT_DIR= libft/
NAME = minishell
#-I /Users/hobenaba/goinfre/homebrew/opt/readline/include/readline -L /Users/hobenaba/goinfre/homebrew/opt/readline/lib
$(NAME) : $(OBJS) $(LIBFT)
