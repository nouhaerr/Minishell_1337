...
#    Updated: 2023/06/19 16:58:59 by hobenaba         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
EXECUTION = exec_bltn_hered.c  execution.c exec_pipes.c begin_exec.c exec_cmd.c
...
SRCS =	main.c $(addprefix ./parsing/, $(PARSING)) signal.c $(addprefix ./execution/, $(EXECUTION)) \
